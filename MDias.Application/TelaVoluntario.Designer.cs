namespace MDias.Application
{
    partial class TelaVoluntario
    {
        ...
        private void InitializeComponent()
        {
            ...
            txtHabilidade = new Guna.UI2.WinForms.Guna2TextBox();
            ...
            formTheme1.Controls.Add(txtHabilidade);
            formTheme1.Controls.Add(txtCPF);
            formTheme1.Controls.Add(txtTelefone);
            ...
            btnCadastrarVoluntarios.Location = new Point(52, 236);
            ...
            btnCadastrarVoluntarios.Click += btnCadastrarVoluntarios_Click;
            // 
            // txtHabilidade
            // 
            txtHabilidade.BorderRadius = 4;
            txtHabilidade.CustomizableEdges = customizableEdges1;
            ...
            txtHabilidade.DisabledState.PlaceholderForeColor = Color.FromArgb(138, 138, 138);
            txtHabilidade.FillColor = Color.FromArgb(224, 224, 224);
            txtHabilidade.FocusedState.BorderColor = Color.FromArgb(94, 148, 255);
            txtHabilidade.Font = new Font("Segoe UI", 10.8F, FontStyle.Regular, GraphicsUnit.Point, 0);
            txtHabilidade.ForeColor = Color.Black;
            ...
            txtHabilidade.PlaceholderForeColor = Color.Black;
            txtHabilidade.PlaceholderText = "Habilidades";
            txtHabilidade.SelectedText = "";
            txtHabilidade.ShadowDecoration.CustomizableEdges = customizableEdges2;
        ...
        private Guna.UI2.WinForms.Guna2TextBox txtHabilidade;
